package com.example.springbootlinebotecho.service;

import com.example.springbootlinebotecho.SpringBootLineBotEchoApplication;
import com.example.springbootlinebotecho.Supplier.ExampleFlexMessageSupplier;
import com.example.springbootlinebotecho.Supplier.MessageWithQuickReplySupplier;
import com.example.springbootlinebotecho.model.LineMessage;
import com.example.springbootlinebotecho.model.LineUser;
import com.example.springbootlinebotecho.model.flexMessageModel.GithubPage;
import com.example.springbootlinebotecho.repository.LineMessageRepository;
import com.example.springbootlinebotecho.repository.LineUserRepository;
...
//                content.getPackageId(), "51626532"));
    ...
    public static DownloadedContent createTempFile(String ext) {
        ...
        Path tempFile = SpringBootLineBotEchoApplication.downloadedContentDir.resolve(fileName);
